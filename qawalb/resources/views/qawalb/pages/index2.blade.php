...
<head>
        ...
        <link rel="stylesheet" href="admin-assets/css/jquery.datetimepicker.css">
         ...
         <!-- ReImageGrid CSS -->
        <link rel="stylesheet" href="admin-assets/css/reImageGrid.css">

        <!-- Switch Style CSS -->
        <link rel="stylesheet" href="admin-assets/css/hover-min.css">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <ul class="profile-notification">
                                             ...
                                             <div class="apply-btn-area">
                                                ...
                                                <div class="login-form" id="login-form" style="display: none;">
                                                   ...
                                                   <form>
                                                        ...
                                                        <a class="btn-login" href="registration.html">Registration</a>
                                        ...
                                        <li><a class="apply-now-btn-color" href="registration.html">Register</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from www.radiustheme.com/demo/html/foxtar/foxtar/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2019 09:39:55 GMT -->
</html>
