...
<!-- Mirrored from www.radiustheme.com/demo/html/foxtar/foxtar/favourites-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2019 09:40:21 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Foxtar | Favourites Grid Page</title>
                        ...
                        <div class="container">
                            <nav id="desktop-nav">
                                <ul>
                                    ...
                                    <li class="active"><a href="#">Pages</a>
                                        <ul class="mega-menu-area"> 
                                            <li>
                                                ...
                                                <a href="product-page-grid.html">Product Grid</a>
                                            </li> 
                                            <li>
                                                <a href="product-page-list.html">Product List</a>
                                                <a href="product-category-grid.html">Category Grid</a>
                                                <a href="product-category-list.html">Category List</a>
                                                <a href="single-product.html">Product Details</a>
                                            </li>
                                            <li>
                                                <a href="profile.html">Profile</a>
                                                <a href="favourites-grid.html">Favourites Grid</a>
                                                <a href="favourites-list.html">Favourites List</a>
                                                <a href="settings.html">Settings</a>
                                            </li>
                                            <li>
                                                <a href="upload-products.html">Upload Products</a>
                                    ...
                                    <li><a href="product-page-grid.html">WordPress</a></li>
                                    <li><a href="product-category-grid.html">Joomla</a></li>
                                    <li><a href="product-category-list.html">Plugins</a></li>
                                    <li><a href="product-page-list.html">Components</a></li>
                ...
                <div class="container">
                    <div class="pagination-wrapper">
                        <ul>
                            ...
                            <li>Favourites Grid</li>
                        </ul>
                    </div>
                </div>  
            </div> 
            <!-- Inner Page Banner Area End Here -->          
            <!-- Favourite Page Start Here -->
            <div class="favourite-page-grid bg-secondary section-space-bottom">
                <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                    <div class="page-controls-sorting">
                                        <div class="dropdown">
                                            <button class="btn sorting-btn dropdown-toggle" type="button" data-toggle="dropdown">150 Favourites Found</button>
                                        </div>
                                    </div>
                                </div>
